<?php $this->load->view('admin/v_header');?>
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Letter Transaction</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
...
<!--        <th class="col-xs-2">Aksi</th>-->
    ...
    <tbody>
        ...
        <tr class="odd gradeX">
            <td><?php echo $letter->id_surat ?></td>
            <td><?php echo $letter->nik ?></td>
            <td><?php echo $letter->deskripsi ?></td>
            <td><?php echo $letter->tgl ?></td>
